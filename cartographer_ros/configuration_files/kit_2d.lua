...
-- Number of ROS messages that make one complete pointcloud (Kitti dataset: one pointcloud gets sent in one message) 
...
-- Define how many scans should be taken to create a submap
